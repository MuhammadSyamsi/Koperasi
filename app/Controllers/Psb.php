...
class Psb extends BaseController
{
    public function index()
    {
        ...
        $data = [
            ...
            'status' => $psbmodel->select('status, count(nama) as jumlah, count(jenjang) as formulir, sum(daftarulang-tdu) as terbayar, sum(daftarulang) as sumdu')->groupBy('status')->where('jenjang', 'mts')->findAll(),
            'statusma' => $psbmodel->select('status, count(nama) as jumlah, count(jenjang) as formulir, sum(daftarulang-tdu) as terbayar, sum(daftarulang) as sumdu')->groupBy('status')->where('jenjang', 'ma')->findAll(),
